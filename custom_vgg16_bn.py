...
data = None
weights_path = "./model/vgg16-cifar.npy" # 模型路径
...
class Vgg16():
    ...
    def build(self, inp):
        ...
        self.fc1 = self.fc_layer(self.drop6, 'fc1', activate= True, bn = True)
    ...
    def fc_layer(self, bottom, name, activate = False, bn = False):
        with tf.variable_scope(name):
